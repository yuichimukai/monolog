...
ActiveRecord::Schema.define(version: 2021_04_06_062255) do
  ...
  create_table "tag_relationsips", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "item_id"
    t.bigint "tag_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["item_id", "tag_id"], name: "index_tag_relationsips_on_item_id_and_tag_id", unique: true
    t.index ["item_id"], name: "index_tag_relationsips_on_item_id"
    t.index ["tag_id"], name: "index_tag_relationsips_on_tag_id"
  end
  ...
  add_foreign_key "tag_relationsips", "items"
  add_foreign_key "tag_relationsips", "tags"
end
