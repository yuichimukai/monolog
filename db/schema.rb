ActiveRecord::Schema.define(version: 2021_04_03_065211) do
	...
	create_table 'tag_relationsips',
		...
		t.datetime 'created_at', precision: 6, null: false
		t.datetime 'updated_at', precision: 6, null: false
		t.index %w[item_id tag_id],
		        name: 'index_tag_relationsips_on_item_id_and_tag_id',
		        unique: true
